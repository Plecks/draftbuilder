...
*/
public class CommandsManager<T> {
 /**
 ...
 public void executeMethod(Method parent, String[] args,
     ...
     invokeMethod(parent, args, method, instance, methodArgs, argsCount);
 
 }

 public void invokeMethod(Method parent, String[] args, Method method,
